...
public class FobControlUnitTest {
	...
	public void testFobAccess() {
		 ...
		 * It's important to realize that the fob just created
		 * has the same ID as another fob object that was added
		 * to the control unit.  However, the display sequence
		 * for these two fob objects is different.
		 *
		 * We want to consider the fob object created above and
		 * the one added to the control unit (created in
		 * the createFobs() method below) as equal because
