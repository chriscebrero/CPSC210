...
public class TwoLists implements Iterable<Integer> {
    ...
    public Iterator<Integer> iterator() {
        switch (new Random().nextInt(3)) {
            case 0:
                return new SuccessiveIterators<Integer>(listone.iterator(), listtwo.iterator());
            case 1:
                return new AlternatingIterators<Integer>(listone.iterator(), listtwo.iterator());
            default:
                return new CartesianIterators(listone.iterator(), listtwo);
        }
    }
}
