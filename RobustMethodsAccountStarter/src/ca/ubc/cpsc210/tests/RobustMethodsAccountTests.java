...
public class RobustMethodsAccountTests {
	...
	public void withdrawTooMuchMoney() throws IllegalValueException, NotEnoughMoneyException {
        a.withdraw(200.0);

	}
	
	@Test (expected = IllegalValueException.class)
	public void withdrawNegativeAmount() throws IllegalValueException, NotEnoughMoneyException {
		a.withdraw(-200.0);
